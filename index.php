<?php
    ...
    //For updating HTML
    //$_SESSION['StudStatus']=3 , Successfully Registered
    if(!isset($_SESSION['StudStatus'])){
        $status=0;
    }else{
        $status=$_SESSION['StudStatus'];
        unset($_SESSION['StudStatus']);
    }
...
<html lang="en">
<head>
    <link rel="stylesheet" href="index.css?v=10.0">
    <meta charset="UTF-8">
...
<body>
    <div class="logdiv">
        ...
        <form action="" method="post">
            <input type="text" name="Username" placeholder="Username" required value="<?php if($status==1)echo isset($_POST['Username']) ? htmlspecialchars($_POST['Username']) : ''; ?>"><br> 
            <input type="password" name="Password" placeholder="Password" required><br> <br>
            <input type="submit" id="login_button" name="Login" value="Login"><br> 
            <p class="note">Don't have an account ? <a href="stud_reg.php" class="link">Register</a> <br><br>
            Professor ?  <a href="prof_login.php" class="link">Professor Portal</a> <br><br>
